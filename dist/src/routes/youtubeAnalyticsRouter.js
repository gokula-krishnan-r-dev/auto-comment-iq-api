...
youtubeanalyticsRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        const values = yield fetchData(startDate, endDate, req.headers.authorization, hero, filter, dimensions, sort);
        res.json({ values });
        // res.json({
        //   values: {
        //     subscribersGained: [
        ...
        console.error("Error fetching data:", ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || error.message);
...
function fetchData(startDate, endDate, authorizationHeader, hero, filter, dimensions, sort) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (currentDate < endDateTime) {
            ...
            const nextMonthDate = currentDate
                .plus({ months: 1 })
                .toFormat("yyyy-MM-dd");
            const promises = metrics.map((metric) => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                const data = yield fetchYouTubeAnalyticsData(formattedDate, nextMonthDate, authorizationHeader, hero, filter, dimensions, sort);
                const value = ((_b = (_a = data === null || data === void 0 ? void 0 : data.rows) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b[metrics.findIndex((item) => item.name === metric.name)]) || 0;
                metric.data.push({
        ...
        metrics.forEach((metric) => {
            ...
            result[metric.name + "_total_count"] = metric.data.reduce((sum, entry) => sum + entry[metric.name], 0);
            // Extract values for percentage change calculation
            const valuesForPercentageChange = metric.data.map((entry) => entry[metric.name]);
            // Calculate percentage change
            result[metric.name + "_percentageChange"] = calculatePercentageChange(valuesForPercentageChange);
        });
        return result;
    });
}
function fetchYouTubeAnalyticsData(startDate, endDate, authorizationHeader, hero, filter, dimensions, sort) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const url = `https://youtubeanalytics.googleapis.com/v2/reports?ids=channel%3D%3DMINE&metrics=${hero}&startDate=${startDate}&endDate=${endDate}${filter ? `&filters=${filter}` : ""} ${dimensions ? `&dimensions=${dimensions}` : ""}${sort ? `&sort=-${hero}` : ""}`;
        const response = yield axios.get(url, {
            headers: {
                Authorization: `Bearer ${(_a = authorizationHeader === null || authorizationHeader === void 0 ? void 0 : authorizationHeader.split(" ")) === null || _a === void 0 ? void 0 : _a[1]}`,
            },
        });
        return response.data;
    });
}
youtubeanalyticsRouter.post("/competitors", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    try {
        ...
        const competitorsData = yield Promise.all(channelIds.map((id) => __awaiter(void 0, void 0, void 0, function* () {
            return yield fetchCompetitorsData(id);
        })));
        res.json(competitorsData);
    }
    catch (error) {
        console.error("Error fetching data:", ((_d = (_c = error.response) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.error) || error.message);
        res.status(500).json({ error: "Internal Server Error" });
    }
}));
function fetchCompetitorsData(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const url = `https://mixerno.space/api/youtube-channel-counter/user/${id.replace(/"/g, "")}`;
            const response = yield axios.get(url);
...
youtubeanalyticsRouter.get("/search/channel/:q", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _e, _f;
    try {
        const { q } = req.params;
        if (!q) {
        ...
        const response = yield fetchChannelData(q);
        res.json(response);
    }
    catch (error) {
        console.error("Error fetching channel data:", ((_f = (_e = error.response) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.error) || error.message);
        res.status(500).json({ error: "Internal Server Error" });
    }
}));
function fetchChannelData(query) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.default = youtubeanalyticsRouter;
//# sourceMappingURL=youtubeAnalyticsRouter.js.map